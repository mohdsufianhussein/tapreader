...
import org.bn.types.*;
    ...
    public class FileCreationTimeStamp implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "FileCreationTimeStamp", isOptional =  false , hasTag =  true, tag = 108, 
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(FileCreationTimeStamp.class);
