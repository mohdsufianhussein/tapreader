...
import org.bn.types.*;
	...
	private NetworkType networkType = null;
        ...
        @ASN1Element ( name = "calledNumAnalysis", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private CalledNumAnalysisList calledNumAnalysis = null;
        ...
        public CalledNumAnalysisList getCalledNumAnalysis () {
            return this.calledNumAnalysis;
        }

        
        public boolean isCalledNumAnalysisPresent () {
            return this.calledNumAnalysis != null;
        }
        

        public void setCalledNumAnalysis (CalledNumAnalysisList value) {
            this.calledNumAnalysis = value;
        }
