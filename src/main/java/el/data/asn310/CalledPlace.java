...
import org.bn.types.*;
    ...
    public class CalledPlace implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "CalledPlace", isOptional =  false , hasTag =  true, tag = 42, 
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(CalledPlace.class);
